...
<main id="main">
    ...
    <section id="blog" class="blog">
        <div class="container">
            <h2 class="text-center">Hasil Pencarian</h2><br>
            <div class="row">
                        ...
                        <?php foreach ($list as $d) : ?>
                            <div class="card mb-3">
                                <div class="row g-0">
                                    <div class="col-md-2">
                                        <a href="">
                                            <img src="<?= base_url(); ?>/img/6.png" alt="..." style="width:175px">
                                        </a>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="card-body">
                                            <h5 class="entry-title" style="font-size: 20px;"><a href="<?php echo $d->url; ?>" target="_blank"><b><?php echo $d->judul; ?></b></a></h5>
                                            <p class="card-text"><?php echo $d->keterangan; ?></p>
                                            <div class="d-inline">
                                                <p class="card-text d-inline mr-2"><small class="text-muted"><i class="icofont-ui-calendar"></i> <?php echo $d->tahun_ditetapkan ?></small></p>
                                                <!-- <p class="card-text d-inline"><small class="text-muted"><i class="icofont-comment"></i> hf </small></p> -->
                                            </div>
                                            <!-- <div class="entry-footer clearfix" style="border:0px"><br><br>
                                                <a href="<?php echo $d->url; ?>" target="_blank">Lihat</a>

                                            </div> -->
                                            <div class="clearfix read-more" style="border:0px"><br><br>
                                                <a class="float-right btn btn-primary" href="<?php echo $d->url; ?>" target="_blank">Download</a>
